            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-2.5 flex-shrink-0 w-full sm:w-auto mt-2 sm:mt-0 pt-3 sm:pt-0 border-t border-[#23262D]/40 sm:border-t-0 sm:items-end">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-1 text-[11px] font-bold px-3 py-1.5 rounded-lg text-emerald-400 border border-emerald-500/20 bg-emerald-500/5 hover:bg-emerald-500/10 transition-all whitespace-nowrap self-start sm:self-auto"
                    >
                      Question &amp; Answer
