  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 60% 45% at 50% 50%, rgba(52,211,153,0.05) 0%, transparent 70%)' }}
      />

      <div className="relative flex flex-col items-center gap-4">
        {/* App name - theme adaptive text color */}
        <div className="text-4xl font-black tracking-tight text-foreground select-none">
          Class<span className="text-[#34D399] drop-shadow-[0_0_12px_rgba(52,211,153,0.25)]">App</span>
        </div>
        ...
        {/* Subtitle */}
        <div
          className="text-[10px] tracking-[0.25em] uppercase font-bold mt-1 text-[#34D399]/60 dark:text-[#34D399]/45"
        >
          Loading
        </div>
      </div>
      ...
      {/* Bottom progress bar */}
      <div className="absolute bottom-0 left-0 right-0 h-0.5 overflow-hidden bg-[#34D399]/5">
        <div
          className="h-full"
          style={{
